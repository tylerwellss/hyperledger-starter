...
echo "$(tput setaf 6)$(tput bold)Sleep 10 seconds while startup completes $(tput sgr0)" && sleep 10

echo "$(tput setaf 6)$(tput bold)Creating Channel $(tput sgr0)" && sleep 2
docker exec peer0.org1.example.com peer channel create -o orderer.example.com:7050 -c composerchannel -f /etc/hyperledger/configtx/composer-channel.tx
echo "$(tput setaf 6)$(tput bold)Channel Created $(tput sgr0)"

echo "$(tput setaf 6)$(tput bold)Joining Peer to Channel $(tput sgr0)" && sleep 2
docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org1.example.com/msp" peer0.org1.example.com peer channel join -b composerchannel.block
echo "$(tput setaf 6)$(tput bold)Peer Joined Channel $(tput sgr0)"
...
echo "$(tput setaf 6)$(tput bold)Install Composer network to Fabric $(tput sgr0)"
...
echo "$(tput setaf 6)$(tput bold)Start business network $(tput sgr0)"
...
echo "$(tput setaf 6)$(tput bold)Remove existing network admin card $(tput sgr0)"
...
echo "$(tput setaf 6)$(tput bold)Import network admin identity $(tput sgr0)"
